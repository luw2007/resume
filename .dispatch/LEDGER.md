...
| CmuxResumeHandoffReview | review / claude_sub2api/claude-sonnet-5 | `../resume` shared review tree | `cmux-handoff-review-a1` | pending | frozen task `.dispatch/CmuxResumeHandoffReview-TASK.md` | `.done/cmux-handoff-review-a1` |
