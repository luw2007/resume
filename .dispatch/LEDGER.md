...
| CmuxResumeHandoffPlan | planner / codex_gpt/gpt-5.6-sol | `../resume` shared planning tree | `cmux-handoff-plan-a1` | `D698D7D6-B11B-4345-B772-FCCB6ED0C1ED`, `λ ⠧ resume` | frozen task `.dispatch/CmuxResumeHandoffPlan-TASK.md` | `.done/cmux-handoff-plan-a1` |
